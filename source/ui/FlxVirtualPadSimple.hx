 ...
 * @author Ka Wing Chin
 */
@:keep @:bitmap("assets/preload/images/virtual-input-simple.png")
class GraphicVirtualInputSimple extends BitmapData {}
 
@:file("assets/preload/images/virtual-input-simple.txt")
class VirtualInputDataSimple extends #if (lime_legacy || nme) ByteArray #else ByteArrayData #end {}

class FlxVirtualPadSimple extends FlxSpriteGroup
{
	...
	{
			#if !web
			var bitmapData = new GraphicVirtualInputSimple(0, 0);
			#end
			...
			*/
			...
			return FlxAtlasFrames.fromSpriteSheetPacker(graphic, Std.string(new VirtualInputDataSimple()));
			#else
