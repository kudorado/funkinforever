...
class Bushwhack extends SongPlayer	
{

    override function getDadTex()
	{
		var tex = Paths.getSparrowAtlas('pc/zardy/ZardyDark', 'mods');
		dad.frames = tex;
	}
	...
	override function loadMap()
	{
		...
		bgAnim.frames = Paths.getSparrowAtlas('bg/zardy/five-minute-song/Zardy2BG', 'mods');
		bgAnim.animation.addByPrefix('idle', 'BG00', 24, true);
