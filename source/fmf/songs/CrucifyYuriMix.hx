...
class CrucifyYuriMix extends SongPlayer
{
    ...
    override function createDadAnimations():Void
    {
        ...
        animation.addByPrefix('idle', 'Yuri Idle', 18, false);
    ...
    override function createDadAnimationOffsets():Void
    {
        ...
        dad.addOffset('singUP', 7, 17);
        dad.addOffset('singRIGHT', 5, 0);
        dad.addOffset('singLEFT', -8, -22);
        dad.addOffset('singDOWN', 47, -7);
        dad.dance();
        dad.scale.x = 1;
        dad.scale.y = 1;
        dad.x = -84;
	...
	{
		icon.loadGraphic(Paths.image('health_icon/dokidoki/icon-yuri', 'mods'), true, 150, 150);
