...
class Sansational extends SongPlayer
{	
	...
	{
		var tex = Paths.getSparrowAtlas('psychengine/week_ic/characters/Sans', 'mods');
		dad.frames = tex;
	}
	...
	override function loadMap()
	{
		...
		var subDirectory = "psychengine/week_ic/";
	...
	override function updateCamFollowBF()
	{
		...
		gameState.targetCamFollow.x -= 750;
