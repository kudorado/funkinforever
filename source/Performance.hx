...
class Performance extends Sprite
{
						...
						showGraph:Bool=false) 
	{
		...
		// performanceText.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, RIGHT);
		// performanceText.setBorderStyle(OUTLINE, 0xFF000000, 3, 1);
		performanceText.defaultTextFormat = new TextFormat(Paths.font("vcr.ttf"), 20, 0xFFFFFF);
