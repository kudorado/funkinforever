...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ESM", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ESM", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "21";
		app.meta["company"] = "HuAngPhuHong";
		app.meta["file"] = "ESM";
		app.meta["name"] = "Everyone Sings";
		app.meta["packageName"] = "com.vswhitty.ballistic.mod";
		app.meta["version"] = "1.1";
